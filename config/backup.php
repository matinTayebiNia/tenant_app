...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'amirkouchaki1@gmail.com'),
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => env('BACKUP_MAX_SIZE_BEFORE_DELETE', 5000),
        ],

        /*
         * The number of attempts, in case the cleanup command encounters an exception
         */
        'tries' => env('BACKUP_TRIES', 1),
