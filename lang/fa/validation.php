...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'has_role' => 'کاربر مورد نظر داری نقش میباشد',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'permissions.*' => ' نام دسترسی ',
        'role_name' => 'نقش ',
        'status' => 'وضعیت',
        'phone' => 'شماره تلفن',
        'current_password' => 'رمز عبور فعلی ',
        'can_edit_profile' => 'قابلیت ویرایش پروفایل',
        'published_at' => 'تاریخ انتشار',
        'description' => 'شرح',
        'tags' => 'برچسب ها',
        'tags.*' => 'برچسب',
        'seo_title' => 'عنوان سئو',
        'seo_content' => 'خلاصه متن سئو',
        'seo_description' => 'توضیحات متا',
        'seo_keyword' => 'کلمات کلیدی',
        'seo_keyword.*' => ' کلمه کلیدی سئو',
